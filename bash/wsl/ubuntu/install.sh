...
# INFO: Variables
poshtheme="pure.omp.json" # themes: https://ohmyposh.dev/docs/themes
...
sudo apt update && sudo apt upgrade -y && sudo apt install -y git curl zip unzip zsh zsh-autosuggestions
