...
schtasks /Create /TN "$TaskFolder\$TaskName" /TR /F "powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File $ScriptPath" `
/SC ONEVENT /EC System /MO "6013" /RU "NT AUTHORITY\LOCALSERVICE"
#/SC ONSTART
